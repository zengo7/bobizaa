...
let top = `*🌈 هقهقهق افضل عشر شواذ بالمجموعة 🌈*
...
if (command == 'توم') {
if (!text) throw `مثال للاستخدام الصحيح:\n.توب اساطير*`
let ps = groupMetadata.participants.map(v => v.id)
let a = ps.getRandom()
let b = ps.getRandom()
let c = ps.getRandom()
...
let top = `*🌸 افضل عشر اوتاكو بالجروب 🌸*
...
let top = `*_😍 5 أزواج رائعين من المجموعة 😍_*
    
*1.- ${user(a)} 💘 ${user(b)}* 
احسن اتنين  💖, اعزموني ع الفرح 🌹

*_2.- ${user(c)} 💘 ${user(d)}_*  
🌹 تستحقو الافضل ف العالم 💞
